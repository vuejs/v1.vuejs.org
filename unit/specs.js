...
/***/ function(module, exports, __webpack_require__) {
	...
	var testsContext = __webpack_require__(109)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _internalState = __webpack_require__(57);
	
	var _internalState2 = _interopRequireDefault(_internalState);
	
	var _internalEvents = __webpack_require__(94);
	
	var _internalEvents2 = _interopRequireDefault(_internalEvents);
	
	var _internalLifecycle = __webpack_require__(95);
	
	var _internalLifecycle2 = _interopRequireDefault(_internalLifecycle);
	
	var _internalMisc = __webpack_require__(97);
	
	var _internalMisc2 = _interopRequireDefault(_internalMisc);
	
	var _apiGlobal = __webpack_require__(98);
	
	var _apiGlobal2 = _interopRequireDefault(_apiGlobal);
	
	var _apiData = __webpack_require__(100);
	
	var _apiData2 = _interopRequireDefault(_apiData);
	
	var _apiDom = __webpack_require__(101);
	
	var _apiDom2 = _interopRequireDefault(_apiDom);
	
	var _apiEvents = __webpack_require__(102);
	
	var _apiEvents2 = _interopRequireDefault(_apiEvents);
	
	var _apiLifecycle = __webpack_require__(103);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _observerIndex = __webpack_require__(50);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(setImmediate) {// can we use __proto__?
	'use strict';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _transitionIndex = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$defineProperties = __webpack_require__(39)['default'];
	
	exports.__esModule = true;
	
	var _parsersText = __webpack_require__(41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parsersDirective = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.assertAsset = assertAsset;
	...
	strats.data = function (parentVal, childVal, vm) {
	  if (!vm) {
	    ...
	    if (typeof childVal !== 'function') {
	      ("development") !== 'production' && _debug.warn('The "data" option should be a function ' + 'that returns a per-instance value in component ' + 'definitions.');
	      return parentVal;
	    }
	    if (!parentVal) {
	      return childVal;
	...
	strats.el = function (parentVal, childVal, vm) {
	  if (!vm && childVal && typeof childVal !== 'function') {
	    ("development") !== 'production' && _debug.warn('The "el" option should be a function ' + 'that returns a per-instance value in component ' + 'definitions.');
	    return;
	  }
	...
	strats.paramAttributes = function () {
	  ...
	  ("development") !== 'production' && _debug.warn('"paramAttributes" option has been deprecated in 0.12. ' + 'Use "props" instead.');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$isExtensible = __webpack_require__(51)['default'];
	...
	function defineReactive(obj, key, val) {
	  ...
	  var getter, setter;
	  if (_config2['default'].convertAllProperties) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _watcher = __webpack_require__(58);
	
	var _watcher2 = _interopRequireDefault(_watcher);
	
	var _compilerIndex = __webpack_require__(62);
	
	var _observerDep = __webpack_require__(55);
	...
	exports['default'] = function (Vue) {
	  ...
	  Vue.prototype._initProps = function () {
	    ...
	    var props = options.props;
	    if (props && !el) {
	      ("development") !== 'production' && _utilIndex.warn('Props will not be compiled if no `el` option is ' + 'provided at instantiation.');
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parsersExpression = __webpack_require__(59);
	
	var _batcher = __webpack_require__(61);
	...
	Watcher.prototype.get = function () {
	  ...
	  try {
	    ...
	    if (("development") !== 'production' && _config2['default'].warnExpressionErrors) {
	      _utilIndex.warn('Error when evaluating expression "' + this.expression + '". ' + (_config2['default'].debug ? '' : 'Turn on debug mode to see stack trace.'), e);
	    }
	  }
	...
	Watcher.prototype.set = function (value) {
	  ...
	  try {
	    ...
	    if (("development") !== 'production' && _config2['default'].warnExpressionErrors) {
	      _utilIndex.warn('Error when evaluating setter "' + this.expression + '"', e);
	    }
	  }
	  ...
	  if (forContext && forContext.alias === this.expression) {
	    if (forContext.filters) {
	      ("development") !== 'production' && _utilIndex.warn('It seems you are using two-way binding on ' + 'a v-for alias (' + this.expression + '), and the ' + 'v-for has filters. This will not work properly. ' + 'Either remove the filters or use an array of ' + 'objects and bind to object properties instead.');
	      return;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _expression = __webpack_require__(59);
	...
	if (true) {
	  warnNonExistent = function (path) {
	    _utilIndex.warn('You are setting a non-existent path "' + path.raw + '" ' + 'on a vm instance. Consider pre-initializing the property ' + 'with the "data" option for more reliable reactivity ' + 'and better performance.');
	  };
	}
	  ...
	  for (var i = 0; i < queue.length; i++) {
	    ...
	    if (("development") !== 'production' && has[id] != null) {
	      ...
	      if (circular[id] > _config2['default']._maxUpdateCount) {
	        ...
	        _utilIndex.warn('You may have an infinite update loop for watcher ' + 'with expression: ' + watcher.expression);
	      }
	    }
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _compile = __webpack_require__(63);
	
	_defaults(exports, _interopExportWildcard(_compile, _defaults));
	
	var _transclude = __webpack_require__(93);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _directivesInternalIndex = __webpack_require__(85);
	
	var _directivesInternalIndex2 = _interopRequireDefault(_directivesInternalIndex);
	
	var _compileProps = __webpack_require__(92);
	
	var _parsersText = __webpack_require__(41);
	
	var _parsersDirective = __webpack_require__(45);
	
	var _parsersTemplate = __webpack_require__(67);
	...
	function compileAndLinkProps(vm, el, props, scope) {
	  var propsLinkFn = _compileProps.compileProps(el, props);
	...
	function makeTerminalNodeLinkFn(el, dirName, value, options, def) {
	  ...
	  var descriptor = {
	    ...
	    def: def || _directivesPublicIndex2['default'][dirName]
	  };
	        ...
	        if (onRE.test(name)) {
	          ...
	          if (bindRE.test(name)) {
	            ...
	            if (matched = name.match(dirAttrRE)) {
	              ...
	              dirDef = _utilIndex.resolveAsset(options, 'directives', dirName);
	
	              if (true) {
	                _utilIndex.assertAsset(dirDef, 'directive', dirName);
	              }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _for = __webpack_require__(68);
	
	var _for2 = _interopRequireDefault(_for);
	
	var _if = __webpack_require__(72);
	...
	var _modelIndex = __webpack_require__(74);
	...
	var _bind = __webpack_require__(80);
	
	var _bind2 = _interopRequireDefault(_bind);
	
	// ref & el
	
	var _el = __webpack_require__(82);
	
	var _el2 = _interopRequireDefault(_el);
	
	var _ref = __webpack_require__(83);
	
	var _ref2 = _interopRequireDefault(_ref);
	
	// cloak
	
	var _cloak = __webpack_require__(84);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function isRealTemplate(node) {
	  return _utilIndex.isTemplate(node) && node.content instanceof DocumentFragment;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fragmentFactory = __webpack_require__(69);
	
	var _fragmentFactory2 = _interopRequireDefault(_fragmentFactory);
	
	var _priorities = __webpack_require__(71);
	...
	var vFor = {
	  ...
	  bind: function bind() {
	    ...
	    if (!this.alias) {
	      ("development") !== 'production' && _utilIndex.warn('Alias is required in v-for.');
	      return;
	    }
	...
	if (true) {
	  vFor.warnDuplicate = function (value) {
	    _utilIndex.warn('Duplicate value found in v-for="' + this.descriptor.raw + '": ' + JSON.stringify(value) + '. Use track-by="$index" if ' + 'you are expecting duplicate values.');
	  };
	}
	  ...
	  bind: function bind() {
	    ...
	    if (!el.__vue__) {
	      ...
	      if (next && _utilIndex.getAttr(next, 'v-else') !== null) {
	        ...
	        this.elseFactory = new _fragmentFactory2['default'](this.vm, next);
	      }
	      // check main block
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _text = __webpack_require__(75);
	...
	exports['default'] = {
	  ...
	  bind: function bind() {
	    ...
	    if (this.hasRead && !this.hasWrite) {
	      ("development") !== 'production' && _utilIndex.warn('It seems you are using a read-only filter with ' + 'v-model. You might want to use a two-way filter ' + 'to ensure correct behavior.');
	    }
	    var el = this.el;
	    var tag = el.tagName;
	    var handler;
	    if (tag === 'INPUT') {
	      ...
	      ("development") !== 'production' && _utilIndex.warn('v-model does not support element type: ' + tag);
	      return;
	    }
	    el.__v_model = this;
	...
	exports['default'] = {
	  ...
	  update: function update(handler) {
	    ...
	    if (typeof handler !== 'function') {
	      ("development") !== 'production' && _utilIndex.warn('v-on:' + this.arg + '="' + this.expression + '" expects a function value, ' + 'got ' + handler);
	      return;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _internalStyle = __webpack_require__(81);
	  ...
	  bind: function bind() {
	    ...
	    if (tokens) {
	      ...
	      if (disallowedInterpAttrRE.test(attr) || attr === 'name' && (tag === 'PARTIAL' || tag === 'SLOT')) {
	        ("development") !== 'production' && _utilIndex.warn(attr + '="' + descriptor.raw + '": ' + 'attribute interpolation is not allowed in Vue.js ' + 'directives and special attributes.');
	      ...
	      if (true) {
	        ...
	        // warn src
	        if (attr === 'src') {
	          _utilIndex.warn(raw + 'interpolation in "src" attribute will cause ' + 'a 404 request. Use v-bind:src instead.');
	        }
	
	        // warn style
	        if (attr === 'style') {
	          _utilIndex.warn(raw + 'interpolation in "style" attribute will cause ' + 'the attribute to be discarded in Internet Explorer. ' + 'Use v-bind:style instead.');
	        }
	      }
	    }
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
	  bind: function bind() {
	    ("development") !== 'production' && _utilIndex.warn('v-ref:' + this.arg + ' must be used on a child ' + 'component. Found on <' + this.el.tagName.toLowerCase() + '>.');
	  }
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = __webpack_require__(86);
	...
	var _prop = __webpack_require__(88);
	  ...
	  build: function build(extraOptions) {
	    ...
	    if (this.Component) {
	      ...
	      if (("development") !== 'production' && this.el.hasAttribute('transition') && child._isFragment) {
	        _utilIndex.warn('Transitions will not work on a fragment instance. ' + 'Template: ' + child.$options.template);
	      }
	      return child;
	    }
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _transitionTransition = __webpack_require__(90);
	...
	exports['default'] = {
	  ...
	  update: function update(id, oldId) {
	    ...
	    id = id || 'v';
	    // apply on closest vm
	    el.__v_trans = new _transitionTransition2['default'](el, id, hooks, this.el.__vue__ || this.vm);
	    if (oldId) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _queue = __webpack_require__(91);
	...
	function Transition(el, id, hooks, vm) {
	  ...
	  if (true) {
	    if (this.type && this.type !== TYPE_TRANSITION && this.type !== TYPE_ANIMATION) {
	      _utilIndex.warn('invalid CSS transition type for transition="' + this.id + '": ' + this.type);
	    }
	  }
	  // bind
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _directivesInternalProp = __webpack_require__(88);
	...
	function compileProps(el, propOptions) {
	  ...
	  while (i--) {
	    ...
	    if (value !== null) {
	      ...
	      ("development") !== 'production' && _utilIndex.warn('Missing required prop: ' + name);
	    }
	    // push prop
	    props.push(prop);
	  }
	      ...
	      if (raw === null) {
	        ...
	        if (vm._context) {
	          if (prop.mode === propBindingModes.ONE_TIME) {
	            ...
	            ("development") !== 'production' && _utilIndex.warn('Cannot bind dynamic prop on a root instance' + ' with no parent: ' + prop.name + '="' + raw + '"');
	          }
	  ...
	  function register(vm, action, key, handler, options) {
	    ...
	    if (type === 'function') {
	      ...
	      if (method) {
	        ...
	        ("development") !== 'production' && _utilIndex.warn('Unknown method: "' + handler + '" when ' + 'registering callback for ' + action + ': "' + key + '".');
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _interopRequireWildcard = __webpack_require__(99)['default'];
	...
	var _parsersPath = __webpack_require__(60);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (Vue) {
	  ...
	  Vue.prototype.$mount = function (el) {
	    if (this._isCompiled) {
	      ("development") !== 'production' && _utilIndex.warn('$mount() should be called only once.');
	      return;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slot = __webpack_require__(105);
	
	var _partial = __webpack_require__(106);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function extractFragment(nodes, parent, main) {
	  ...
	  function append(node) {
	    ...
	    node = _parsersTemplate.cloneNode(node);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _publicIf = __webpack_require__(72);
	...
	exports['default'] = {
	  ...
	  insert: function insert(id) {
	    var partial = _utilIndex.resolveAsset(this.vm.$options, 'partials', id);
	    if (true) {
	      _utilIndex.assertAsset(partial, 'partial', id);
	    }
	    if (partial) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _arrayFilters = __webpack_require__(108);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _directivesPublicFor = __webpack_require__(68);
	...
	function filterBy(arr, search, delimiter) {
	  ...
	  var keys = _utilIndex.toArray(arguments, n).reduce(function (prev, cur) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		...
		"./api/events_spec": 112,
		"./api/global_spec": 113,
		"./api/lifecycle_spec": 114,
		"./async_component_spec": 115,
		"./batcher_spec": 116,
		"./cache_spec": 117,
		"./compiler/compile_spec": 118,
		"./compiler/transclude_spec": 119,
		"./directive_spec": 120,
		"./directives/element/partial_spec": 121,
		"./directives/element/slot_spec": 122,
		"./directives/internal/class_spec": 123,
		"./directives/internal/component_spec": 124,
		"./directives/internal/prop_spec": 125,
		"./directives/internal/style_spec": 126,
		"./directives/internal/transition_spec": 127,
		"./directives/public/bind_spec": 128,
		"./directives/public/cloak_spec": 129,
		"./directives/public/el_spec": 130,
		"./directives/public/for/for_ref_spec": 131,
		"./directives/public/for/for_spec": 132,
		"./directives/public/for/for_stagger_spec": 133,
		"./directives/public/html_spec": 134,
		"./directives/public/if_spec": 135,
		"./directives/public/model_spec": 136,
		"./directives/public/on_spec": 137,
		"./directives/public/pre_spec": 138,
		"./directives/public/ref_spec": 139,
		"./directives/public/show_spec": 140,
		"./directives/public/text_spec": 141,
		"./filters/filters_spec": 142,
		"./instance/events_spec": 143,
		"./instance/init_spec": 144,
		"./instance/misc_spec": 145,
		"./instance/state_spec": 146,
		"./misc_spec": 147,
		"./observer/dep_spec": 148,
		"./observer/observer_spec": 149,
		"./parsers/directive_spec": 150,
		"./parsers/expression_spec": 151,
		"./parsers/path_spec": 152,
		"./parsers/template_spec": 153,
		"./parsers/text_spec": 154,
		"./transition/transition_spec": 155,
		"./util/component_spec": 156,
		"./util/debug_spec": 157,
		"./util/dom_spec": 158,
		"./util/env_spec": 159,
		"./util/lang_spec": 160,
		"./util/options_spec": 161,
		"./watcher_spec": 162
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vue = __webpack_require__(1)
	var compiler = __webpack_require__(62)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var config = __webpack_require__(38)
	var batcher = __webpack_require__(61)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var publicDirectives = __webpack_require__(64)
	var internalDirectives = __webpack_require__(85)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var transclude = __webpack_require__(62).transclude
	var Vue = __webpack_require__(1)
	var _ = __webpack_require__(5)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vue = __webpack_require__(1)
	var Directive = __webpack_require__(96)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var compile = __webpack_require__(62).compile
	var Vue = __webpack_require__(1)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var filters = __webpack_require__(107)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parse = __webpack_require__(45).parseDirective
...
/***/ function(module, exports, __webpack_require__) {
	...
	var templateParser = __webpack_require__(67)
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('Util - Option merging', function () {
	  ...
	  it('already observed instance data merge with default data', function () {
	    var observe = __webpack_require__(50).observe
